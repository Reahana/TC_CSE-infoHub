...
@section('body')
    <div class="row">
        <div class="col-md-12">
            <div class="ibox mt-3">
                <div class="ibox-head">
                    <div class="ibox-title">All Course Teacher info goes here</div>
                </div>
                <div class="ibox-body">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0" width="100%">
                        ...
                        @foreach($teachers as $teacher)
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('courseTeacher.edit', ['id' => $teacher->id])}}" class="btn btn-success btn-xs">
                                    ...
                                    <form action="{{route('courseTeacher.delete', ['id' => $teacher->id])}}" method="POST" id="teacherDeleteForm{{$teacher->id}}">
                                        @csrf
                                    </form>
                                </td>
                            </tr>
