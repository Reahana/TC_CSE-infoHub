                    ...
                    <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0" width="100%">
                        ...
                        @foreach($routines as $routine)
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('edit.routine', ['id' => $routine->id])}}" class="btn btn-success btn-xs">
                                    ...
                                    <form action="{{route('delete.routine', ['id' => $routine->id])}}" method="POST" id="routineDeleteForm{{$routine->id}}">
                                        @csrf
                                    </form>
                                </td>
                            </tr>
