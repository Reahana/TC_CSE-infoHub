        ...
        <div class="ibox mt-3">
            ...
            <div class="ibox-body">
               @if($message = Session::get('message'))
                ...
                @endif
                <form class="form-horizontal" action="{{route('student.updatePassword',['id'=>$student->id])}}" method="POST" enctype="multipart/form-data">
                    @csrf
		 <div class="form-group row">
                  ...
                  <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" type="text" name="password" value="{{$student->password}}" placeholder="Password"/>
                        </div>
                    </div>
                    <div class="form-group row">
