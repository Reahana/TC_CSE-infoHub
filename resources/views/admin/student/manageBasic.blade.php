...
@section('body')
	...
	<div class="row">
        <div class="col-md-12">
            <div class="ibox mt-3">
                <div class="ibox-head">
                    <div class="ibox-title">All Student Basic info goes here</div>
                </div>
                <div class="ibox-body">
		...
		<td><img src="{{asset($student->image)}}" alt="" height="70" width="100"></td>
      				<td>
                                <a href="{{route('student.editBasic', ['id' => $student->id])}}" class="btn btn-success btn-xs">
