...
@section('body')
    <div class="row">
        <div class="col-md-12">
            <div class="ibox mt-3">
                <div class="ibox-head">
                    <div class="ibox-title">Edit Guest Teacher Form</div>
                ...
                <div class="ibox-body">
                    ...
                    @foreach($teachers as $teacher)
                            <form class="form-horizontal" action="{{route('g-tea-profile.update',['id'=>$teacher->id])}}" method="POST" enctype="multipart/form-data">
                                @csrf
